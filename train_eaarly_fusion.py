...
def main(args):
    ...
    model = train_model(
        ...
        model_name=f"early_fusion_{args.text_model}_{args.image_model}{
    ...
    plot_confusion_matrix(
        ...
        save_path=os.path.join(args.figure_dir, f"early_fusion_cm.png")
    )
    
    # Plot ROC curve
    plot_roc_curve(
        all_labels, all_scores,
        save_path=os.path.join(args.figure_dir, f"early_fusion_roc.png")
    )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Train early fusion model for hateful memes detection")
    ...
    parser.add_argument('--use_attention', action='store_true', help='Use cross-modal attention')
